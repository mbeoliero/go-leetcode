...
# sh IconChanger.sh
# replace the x.png and x@2x.png
# press a random key in terminal and then press "Y"
# reboot
...
if [ $IS_CSRUTIL_DISABLED == 'enabled' ] || [ $IS_AUTH_ROOT_DISABLED == 'enabled' ]; then
...
if [ $selection == 'Y' ] || [ $selection == 'y' ] || [ $selection == 'Yes' ] || [ $selection == 'yes' ]; then
  echo ""
